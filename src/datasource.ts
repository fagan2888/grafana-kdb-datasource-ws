...
//                    }
    ...
    query(options) {
        ...
        console.log('prc', prefilterResultCount)
        ...
        var errorList = [];
        console.log('vrl',validRequestList)
        console.log('el',errorList)
        ...
        for(var i = 0; i < prefilterResultCount; i++){
            ...
            if ((options.targets[i].hide === true) || (options.targets[i].blankQuery )) {
